...
def opacity(nu, T, n_HI, n_e, n_l, Blu, rv, line='halpha'):
    """
    Calculate the absorption coefficient kappa
    ...
    # print(0.00000265 * f_line * phi_nu * n_l * ( 1 - np.exp(-constants.h * nu / (constants.k * T ))))
    return 0.00000265 * f_line * phi_nu * n_l * ( 1 - np.exp(-constants.h * nu / (constants.k * T )))
